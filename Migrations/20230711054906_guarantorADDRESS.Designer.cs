...
namespace Debt_Calculation_And_Repayment_System.Migrations
{
    ...
    [Migration("20230711054906_guarantorADDRESS")]
    partial class guarantorADDRESS
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Debt_Calculation_And_Repayment_System.Models.DEBTREGISTER", b =>
                {
                    ...
                    b.Property<decimal>("InterestRateDelay")
                        .HasPrecision(10, 4)
                        .HasColumnType("decimal(10,4)");

                    b.Property<decimal>("InterestRateInstallment")
                        .HasPrecision(10, 4)
                        .HasColumnType("decimal(10,4)");
            ...
            modelBuilder.Entity("Debt_Calculation_And_Repayment_System.Models.DOCUMENT", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Debt_Calculation_And_Repayment_System.Models.EMAILTEMPLATE", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Debt_Calculation_And_Repayment_System.Models.PROGRAMTYPE", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Debt_Calculation_And_Repayment_System.Models.STUDENTSTATUSTYPE", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Debt_Calculation_And_Repayment_System.Models.USER", b =>
                {
                    ...
                    b.Property<string>("GuarantorMobile")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Debt_Calculation_And_Repayment_System.Models.STUDENT", b =>
                {
                    ...
                    b.Property<bool>("StaffMemberAssigned")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Debt_Calculation_And_Repayment_System.Models.STUDENT", b =>
                {
                    b.HasOne("Debt_Calculation_And_Repayment_System.Models.PROGRAMTYPE", "ProgramType")
                        .WithMany()
